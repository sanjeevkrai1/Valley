...
public class ValidateOtpTplinkResBean {
	...
	public ValidateOtpTplinkResBean() {
		super();
	}

	public ValidateOtpTplinkResBean(String status, String reason, String macAddress, String userName, String emailId,
