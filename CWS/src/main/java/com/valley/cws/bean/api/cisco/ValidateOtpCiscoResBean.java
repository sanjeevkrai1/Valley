...
public class ValidateOtpCiscoResBean {
	...
	public ValidateOtpCiscoResBean() {
		super();
	}

	public ValidateOtpCiscoResBean(String status, String reason, String macAddress, String userName, String emailId,
