...
public class RateTplinkAdBean {
	...
	public RateTplinkAdBean() {
		super();
	}

	public RateTplinkAdBean(int adId, Boolean isLike, Boolean isDisLike, Boolean isRating, Integer ratingPoint) {
		super();
		this.adId = adId;
		this.isLike = isLike;
