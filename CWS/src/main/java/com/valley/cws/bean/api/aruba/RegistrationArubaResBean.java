...
public class RegistrationArubaResBean {
	...
	public RegistrationArubaResBean() {
		super();
	}

	public RegistrationArubaResBean(String status, String reason, String url, String login, String cmd,
