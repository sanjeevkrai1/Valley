...
public class RateTplinkReqBean {

	private List<RateTplinkAdBean> adList;
	...
	public RateTplinkReqBean() {
		super();
	}

	public RateTplinkReqBean(List<RateTplinkAdBean> adList, String macAddress, Boolean isActivity, Boolean isSchedule,
	...
	public List<RateTplinkAdBean> getAdList() {
		return adList;
	}

	public void setAdList(List<RateTplinkAdBean> adList) {
		this.adList = adList;
	}
