...
public class ValidateOtpArubaResBean {
	...
	public ValidateOtpArubaResBean() {
		super();
	}

	public ValidateOtpArubaResBean(String status, String reason, String macAddress, String userName, String emailId,
