...
public class RedirectArubaResBean {
	...
	public RedirectArubaResBean() {
		super();
	}

	public RedirectArubaResBean(String status, String reason, String macAddress, String action, Boolean isAd, List<AdBean> adUrls,
			Integer screenType) {
		super();
		this.status = status;
		this.reason = reason;
