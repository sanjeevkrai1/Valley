...
public class RedirectTplinkResBean {
	...
	public RedirectTplinkResBean() {
		super();
	}

	public RedirectTplinkResBean(String status, String reason, String macAddress, String action, Boolean isAd, List<AdBean> adUrls,
			Integer screenType) {
		super();
		this.status = status;
		this.reason = reason;
	...
	public String toString() {
		return "[ status : " + status + " ] , [ reason : " + reason + " ] , [ macAddress : " + macAddress + " ] , [ action : " + action
				+ " ] , [ isAd : " + isAd + " ] , [ adUrls : " + adUrls + " ] , [ screenType : " + screenType + " ] ";
	}
