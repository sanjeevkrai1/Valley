...
public class RateCiscoReqBean {

	private List<RateCiscoAdBean> adList;
	...
	public RateCiscoReqBean() {
		super();
	}

	public RateCiscoReqBean(List<RateCiscoAdBean> adList, String macAddress, Boolean isActivity, Boolean isSchedule,
	...
	public List<RateCiscoAdBean> getAdList() {
		return adList;
	}

	public void setAdList(List<RateCiscoAdBean> adList) {
		this.adList = adList;
	}
