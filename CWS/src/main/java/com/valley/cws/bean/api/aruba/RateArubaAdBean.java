...
public class RateArubaAdBean {
	...
	public RateArubaAdBean() {
		super();
	}

	public RateArubaAdBean(int adId, Boolean isLike, Boolean isDisLike, Boolean isRating, Integer ratingPoint) {
		super();
		this.adId = adId;
		this.isLike = isLike;
